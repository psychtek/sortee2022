...
<div class="notes">
A version control system is a way to syncronize and track changes in a project file. This includes what and by whom was changed and then, these are sent to a server so other contributors and collaborators can manage the same files. This essentially is the modern day version of avoiding this: </div>
